...
| `VIBE_MCP_HOST` | Runtime | Value of `HOST` | MCP server connection host (use `127.0.0.1` when `HOST=0.0.0.0` on Windows) |
| `VIBE_MCP_PORT` | Runtime | Value of `BACKEND_PORT` | MCP server connection port |
