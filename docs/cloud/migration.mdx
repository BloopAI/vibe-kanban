...
1. **A Cloud account** - Sign in with GitHub or Google
2. **An organisation** - Create one if you haven't already
3. **Local projects** - Projects stored on your machine that you want to migrate
...
There are two ways to access the migration wizard:

### From the User Menu

1. Click your **profile avatar** in the top-right corner
2. Select **Migrate to Cloud** from the menu

### From the Welcome Screen

If you have local projects but haven't migrated yet, you may see a prompt to migrate when you open Vibe Kanban.
...
3. You'll see a progress indicator during the process
...
Once migration completes, you'll see a summary report showing:
...
Click **Finish** to complete the wizard and start using your Cloud projects.
