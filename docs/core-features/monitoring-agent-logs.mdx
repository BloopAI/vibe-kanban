...
<Tip>
For development server logs, the recommended way to view them is through [Testing Your Application](/core-features/preview-mode) where you can see logs alongside the live preview.
</Tip>

## Related Documentation

- [Testing Your Application](/core-features/preview-mode) - Test your application with live preview and dev server logs
