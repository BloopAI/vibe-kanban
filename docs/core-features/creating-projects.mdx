...
The dev server script is run when you press the "Start Dev Server" button from the [Preview](/core-features/preview-mode) section. It's useful for quickly reviewing work after a coding agent has run.
