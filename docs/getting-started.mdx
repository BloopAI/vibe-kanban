...
Start the Agent Kanban client and open the UI in your browser:
...
## 3. Sign-in to Agent Kanban

You can use a GitHub or Google account.

<Frame>
  <img src="/images/onboarding-sign-in.png" alt="Agent Kanban onboarding screen showing Sign in to continue with GitHub and Google buttons" />
</Frame>
