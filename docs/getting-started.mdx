...
To enable task sharing, see the [API Key Requirements documentation](https://github.com/BloopAI/vibe-kanban/blob/main/API_KEY_REQUIREMENTS.md) for setup instructions.
