...
Insert task tags into task descriptions using @mention autocomplete.
...
<Tip>
Task tags work in all text fields that support the @mention feature, making it easy to maintain consistency across your tasks.
</Tip>
