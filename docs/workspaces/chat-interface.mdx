...
|--------|----------|-------------|
| **Send** | `Cmd/Ctrl + Enter` | Send immediately (while running, this acts as high-priority steer) |
| **Queue** | Click Queue button | Buffer a follow-up while agent is running |
...
- **Queue** appends a buffered follow-up.
