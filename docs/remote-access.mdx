---
title: "Remote Access"
description: "Access your local Agent Kanban instance from another device"
---

Remote Access allows you to access a host instance of Agent Kanban from another device, like your mobile phone.

# 1. Launch Agent Kanban on the host device

Make sure you've started Agent Kanban and logged in.
...
<Frame>
  <img style={{maxHeight: "500px"}} src="/images/remote-access-cloud-mobile.png" alt="Agent Kanban cloud remote access page on mobile showing a paired host and workspaces" />
</Frame>
