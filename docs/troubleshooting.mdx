...
If you encounter persistent issues or need to completely reset Vibe Kanban's cached data, you can delete the application data directory for your operating system.

<Warning>
Deleting these directories will remove all cached data and settings. Make sure to back up any important information before proceeding.
</Warning>
...
After deleting the cache directory, restart Vibe Kanban to reinitialize with fresh settings.
