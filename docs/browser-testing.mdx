...
Logs stream in real-time in the **Log** panel so you can see when the server is ready. Look for the URL output (e.g. `http://localhost:3000`) — Vibe Kanban detects this automatically and loads it in the preview.
