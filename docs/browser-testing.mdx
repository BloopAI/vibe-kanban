...
3. **URL bar** — shows the current page address; type a URL to navigate manually
4. **Page actions** — submit, copy the URL, open in a new tab, and refresh
5. **Desktop mode** — full-width browser view
6. **Mobile mode** — phone frame at 390×844
7. **Responsive mode** — drag the edges to set custom dimensions
