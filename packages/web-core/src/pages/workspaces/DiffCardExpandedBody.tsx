...
export function DiffCardExpandedBody({
  ...
  // useEffect MUST be called unconditionally (before any early returns) to
  // avoid "Rendered more hooks than during the previous render" crash when
  // forceExpanded toggles shouldShowPlaceholder from true → false.
  useEffect(() => {
  ...
  }, [additions, deletions, filePath, onReadyChange, shouldShowPlaceholder]);
