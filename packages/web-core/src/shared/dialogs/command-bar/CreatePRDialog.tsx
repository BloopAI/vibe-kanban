...
const CreatePRDialogImpl = create<CreatePRDialogProps>(
  ({ attempt, repoId, targetBranch, issueIdentifier }) => {
    ...
    useEffect(() => {
      if (createEmptyPr) {
        // When empty PR is enabled, clear fields and disable auto-generate
        setPrTitle('');
        setPrBody('');
    ...
    useEffect(() => {
      ...
      const initializePRFields = async () => {
        // Skip initialization if empty PR is enabled
        if (createEmptyPr) {
          setPrTitle('');
          setPrBody('');
          return;
          ...
          <DialogContent className="sm:max-w-[525px]">
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={creatingPR || (!createEmptyPr && !prTitle.trim())}
