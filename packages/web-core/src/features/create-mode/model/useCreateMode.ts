...
import type { DraftWorkspaceFile, Repo, ExecutorConfig } from 'shared/types';
...
export interface CreateModeContextValue {
  ...
  /** Uploaded files persisted in the draft */
  files: DraftWorkspaceFile[];
  /** Update draft files (triggers debounced scratch save) */
