...
import { ImageIcon, WarningIcon } from '@phosphor-icons/react';

interface ExportOptionsProps {
  includeAttachments: boolean;
  onContinue: (includeAttachments: boolean) => void;
  onBack: () => void;
}
    ...
    <div className="p-double space-y-double">
      <div className="space-y-base">
        ...
        <p className="text-sm text-normal">
          Issues, projects, assignees, and users are always included.
        </p>
      </div>
      ...
      <div className="flex gap-base">
        ...
        <button
          onClick={() => onContinue(includeAttachments)}
