...
export type CursorMcpMessage = { id: string, session_id: string, 
/**
 * "assistant" for messages produced by Cursor's Agent via
 * `wait_for_user_input`, "user" for replies typed in the vibe-kanban UI.
 */
role: CursorMcpRole, body: string, created_at: string, };

export type CursorMcpWaitInfo = { request_id: string, session_id: string, message: string, prompt: string | null, enqueued_at: string, 
/**
 * `enqueued_at + FORCE_RENEW_INTERVAL` — the UI uses this for the
 * countdown shown next to the wait.
 */
renew_deadline_at: string, };

export type CursorMcpSessionSnapshot = { session_id: string, messages: Array<CursorMcpMessage>, pending_waits: Array<CursorMcpWaitInfo>, bridge_connected: boolean, };
...
export type BridgeWaitRequest = { session_id: string, 
/**
 ...
 */
message: string, prompt: string | null, title: string | null, };

export type BridgeWaitResponse = { 
/**
