...
export type EditorConstants = {
  editor_types: Array<EditorType>;
  editor_labels: Array<string>;
};
...
export type SoundConstants = {
  sound_files: Array<SoundFile>;
  sound_labels: Array<string>;
};

export type ConfigConstants = {
  editor: EditorConstants;
  sound: SoundConstants;
};
...
export type ExecutorConfig =
  ...
  | { type: "amp" }
  | { type: "gemini" }
  | { type: "setupscript"; script: string }
  | { type: "charmopencode" };

export type ExecutorConstants = {
  executor_types: Array<ExecutorConfig>;
  executor_labels: Array<string>;
};
...
export type CreateExecutorSession = {
  task_attempt_id: string;
  execution_process_id: string;
  prompt: string | null;
};

export type UpdateExecutorSession = {
  session_id: string | null;
  prompt: string | null;
  summary: string | null;
};
