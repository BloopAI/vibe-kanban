...
export type EditorPickerRepo = { id: string, name: string, display_name: string, effective_editor_type: string | null, editor_launch_target: string | null, };

export type EditorPickerResponse = { repos: Array<EditorPickerRepo>, };
