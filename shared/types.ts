...
export type DiffCollapseDefaults = { added: boolean, deleted: boolean, modified: boolean, renamed: boolean, copied: boolean, permissionChange: boolean, };
