...
export function ExecutorsSettings() {
    ...
    const [selectedExecutorType, setSelectedExecutorType] =
        useState<string>('AMP');
    const [selectedConfiguration, setSelectedConfiguration] = useState<string>('DEFAULT');
    ...
    const validateConfigName = (name: string): string | null => {
        ...
        if (trimmedName.length > 40) return 'Configuration name must be 40 characters or less';
    ...
    const handleDeleteConfiguration = async () => {
        ...
        try {
            ...
            const currentConfigs = Object.keys(parsedProfiles.executors[selectedExecutorType] || {});
            ...
            const { [configToDelete]: _removed, ...remainingConfigs } =
            ...
            try {
                ...
                const nextConfigs = Object.keys(updatedProfiles.executors[selectedExecutorType]);
                ...
                setDeleteError(saveError.message || 'Failed to save deletion. Please try again.');
            } finally {
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            ...
                                            disabled={
                                                profilesSaving ||
                                                !parsedProfiles.executors[selectedExecutorType] ||
                                                Object.keys(parsedProfiles.executors[selectedExecutorType] || {}).length <= 1
                                            }
                                            title={
                                                Object.keys(parsedProfiles.executors[selectedExecutorType] || {}).length <= 1
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={cloneFrom || '__blank__'} onValueChange={(value) => setCloneFrom(value === '__blank__' ? null : value)}>
