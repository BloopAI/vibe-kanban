...
import { ThemeMode, EditorType, SoundFile, ExecutorProfileId, BaseCodingAgent } from 'shared/types';
                            ...
                            <Select
                                ...
                                onValueChange={(value: string) => {
                                    ...
                                    const newProfile: ExecutorProfileId = {
                                        ...
                                        variant: keepCurrentVariant ? config.executor_profile!.variant : null,
                                    };
                                    updateConfig({
