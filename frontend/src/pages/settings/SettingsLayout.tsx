  ...
  return (
    <div className="container mx-auto px-4 py-8 relative">
      <Button
        ...
        className="absolute top-2 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 z-10"
      >
        <X className="h-4 w-4" />
