  ...
  ({ attempt, task, repoId, targetBranch }) => {
    ...
    const handleConfirmCreatePR = useCallback(async () => {
      ...
      if (result.success && result.data) {
        ...
        if (
          !conflict_resolution ||
          conflict_resolution.status === 'resolved'
        ) {
          setTimeout(() => {
            setPrTitle('');
            setPrBody('');
              ...
              <div className="space-y-4 py-4">
                ...
                >
                  ...
                  <AlertTitle className="text-green-700 dark:text-green-400">
                    {t('createPrDialog.success.prCreated', 'PR Created Successfully')}
                  </AlertTitle>
                  <AlertDescription className="text-green-600 dark:text-green-300">
                    {t('createPrDialog.success.prCreatedDescription', 'Your pull request has been created.')}
                  </AlertDescription>
                </Alert>
                ...
                {conflictResolution?.status === 'resolved' && (
                  ...
                  >
                    <CheckCircle className="h-4 w-4 text-green-600" />
                    <AlertTitle className="text-green-700 dark:text-green-400">
                      {t('createPrDialog.conflicts.resolved', 'Merge Conflicts Resolved')}
                    </AlertTitle>
                    <AlertDescription className="text-green-600 dark:text-green-300">
                      {t(
                ...
                {conflictResolution?.status === 'failed' && (
                  <Alert variant="default" className="border-amber-500 bg-amber-50 dark:bg-amber-950/20">
                    ...
                    <AlertTitle className="text-amber-700 dark:text-amber-400">
                      {t('createPrDialog.conflicts.detected', 'Merge Conflicts Detected')}
                    </AlertTitle>
                      ...
                      {conflictResolution.conflicted_files.length > 0 && (
                        <div className="mt-2">
                          <p className="text-sm font-medium text-amber-700 dark:text-amber-400">
                            {t('createPrDialog.conflicts.conflictedFiles', 'Conflicted files:')}
                          </p>
