...
interface NoServerContentProps {
  ...
  isEditingExistingScript: boolean;
  devScriptInput: string;
  setDevScriptInput: (value: string) => void;
  saveError: string | null;
  isSavingDevScript: boolean;
  handleSaveDevScript: (startAfterSave?: boolean) => Promise<void>;
  handleEditExistingScript: () => void;
          ...
          {!effectiveHasDevScript && (
            <div className="mt-4 text-left space-y-2 max-w-md">
              <p className="text-xs text-muted-foreground">
                No "dev" script found. Add one below (e.g., Next.js: npm run
                dev, Vite: vite):
              </p>
              <Label htmlFor="inline-dev-script" className="text-xs">
                Dev server script
              </Label>
              <textarea
      ...
      <div className={`flex-1 flex flex-col min-h-0`}>
        {mode === 'ready' ? (
          ...
          <NoServerContent
            ...
            isEditingExistingScript={isEditingExistingScript}
            devScriptInput={devScriptInput}
            setDevScriptInput={setDevScriptInput}
            isSavingDevScript={isSavingDevScript}
            saveError={saveError}
            handleSaveDevScript={handleSaveDevScript}
            handleEditExistingScript={handleEditExistingScript}
        ...
        {mode === 'ready' && loadingTimeFinished && !isReady && (
          <Alert variant="destructive">
            It looks like we're having trouble loading a preview of your
            application.{' '}
            ...
            <ol className="list-decimal list-inside">
              ...
              <li>
                Does your dev server print the URL and port to the terminal?
