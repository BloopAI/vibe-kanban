...
import { CopyIcon, MagnifyingGlassIcon, CheckCircleIcon } from '@phosphor-icons/react';
...
const DeduplicateTasksDialogImpl = NiceModal.create<DeduplicateTasksDialogProps>(() => {
...
export const DeduplicateTasksDialog = defineModal<DeduplicateTasksDialogProps, DeduplicateTasksResult>(
