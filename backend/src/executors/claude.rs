...
Task title: {}"#,
        ...
        if !attachments.is_empty() {
            prompt.push_str("\n\nThe following files have been attached to this task. Please read and analyze them using your Read tool:");
            for attachment in attachments {
                // Include the absolute file path that Claude can access
                ...
                prompt.push_str(&format!(
                    "\n  Action required: Please use your Read tool to view this {} file and incorporate its content into your response.",
