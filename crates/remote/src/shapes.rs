...
pub use crate::entities::{
    ...
    NOTIFICATION_SHAPE as NOTIFICATIONS,
    WORKSPACE_SHAPE as WORKSPACES,
    PROJECT_STATUS_SHAPE as PROJECT_STATUSES,
    TAG_SHAPE as TAGS,
    ISSUE_SHAPE as ISSUES,
    ISSUE_ASSIGNEE_SHAPE as ISSUE_ASSIGNEES,
    ISSUE_FOLLOWER_SHAPE as ISSUE_FOLLOWERS,
    ISSUE_TAG_SHAPE as ISSUE_TAGS,
    ISSUE_RELATIONSHIP_SHAPE as ISSUE_RELATIONSHIPS,
    ISSUE_COMMENT_SHAPE as ISSUE_COMMENTS,
    ISSUE_COMMENT_REACTION_SHAPE as ISSUE_COMMENT_REACTIONS,
    all_shapes,
};
