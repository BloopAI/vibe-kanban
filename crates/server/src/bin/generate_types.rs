...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::task_attempts::images::AssociateWorkspaceImagesRequest::decl(),
        server::routes::task_attempts::images::ImportIssueAttachmentsRequest::decl(),
        server::routes::task_attempts::images::ImportIssueAttachmentsResponse::decl(),
