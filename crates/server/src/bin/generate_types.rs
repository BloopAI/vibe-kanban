...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::scratch::DraftWorkspaceFile::decl(),
        ...
        db::models::file::File::decl(),
        db::models::file::CreateFile::decl(),
        ...
        server::routes::files::FileResponse::decl(),
        server::routes::files::FileMetadata::decl(),
        ...
        server::routes::workspaces::files::AssociateWorkspaceFilesRequest::decl(),
        server::routes::workspaces::files::ImportIssueAttachmentsRequest::decl(),
        server::routes::workspaces::files::ImportIssueAttachmentsResponse::decl(),
