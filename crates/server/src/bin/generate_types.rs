...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::discovery_item::DiscoveryItem::decl(),
        db::models::discovery_item::DiscoveryItemType::decl(),
        db::models::discovery_item::DiscoveryStatus::decl(),
        db::models::discovery_item::CreateDiscoveryItem::decl(),
        db::models::discovery_item::UpdateDiscoveryItem::decl(),
        db::models::feedback_entry::FeedbackEntry::decl(),
        db::models::feedback_entry::FeedbackType::decl(),
        db::models::feedback_entry::CreateFeedbackEntry::decl(),
