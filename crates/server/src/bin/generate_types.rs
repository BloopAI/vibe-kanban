...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::services::drafts::DraftResponse::decl(),
        server::services::drafts::UpdateFollowUpDraftRequest::decl(),
        server::services::drafts::UpdateRetryFollowUpDraftRequest::decl(),
