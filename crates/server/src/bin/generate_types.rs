...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        executors::executors::claude::types::ClaudeCodeSettings::decl(),
        executors::executors::claude::types::ClaudeCodePermissions::decl(),
        executors::executors::claude::types::ClaudeCodeHooks::decl(),
        executors::executors::claude::types::ClaudeCodeHookEntry::decl(),
        executors::executors::claude::types::ClaudeCodeHookAction::decl(),
