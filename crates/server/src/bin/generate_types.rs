...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::files::AttachmentResponse::decl(),
        server::routes::files::AttachmentMetadata::decl(),
        ...
        server::routes::workspaces::files::AssociateWorkspaceAttachmentsRequest::decl(),
