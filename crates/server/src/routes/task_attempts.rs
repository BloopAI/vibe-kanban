...
// Draft response/types moved to routes::task_attempt_drafts

// UpdateFollowUpDraftRequest moved to routes::task_attempt_drafts

// UpdateRetryFollowUpDraftRequest moved to routes::task_attempt_drafts

// SetQueueRequest moved to routes::task_attempt_drafts

// Draft helpers moved to routes::task_attempt_drafts

// save_follow_up_draft moved to routes::task_attempt_drafts

// save_retry_follow_up_draft moved to routes::task_attempt_drafts

// delete_retry_follow_up_draft moved to routes::task_attempt_drafts

// unified draft fetch helper provided above; route-level update helper removed in favor of db::models::draft::Draft::update_partial

// follow-up draft WS moved to routes::task_attempt_drafts

// set_follow_up_queue moved to routes::task_attempt_drafts

// start_follow_up_from_draft moved to routes::task_attempt_drafts
...
pub fn router(deployment: &DeploymentImpl) -> Router<DeploymentImpl> {
    let task_attempt_id_router = Router::new()
        ...
        // Keep existing attempt-level WS for drafts (path unchanged to avoid client churn)
        .route(
            "/follow-up-draft/stream/ws",
            get(task_attempt_drafts::stream_follow_up_draft_ws),
        )
