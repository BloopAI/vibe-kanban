...
impl EventService {
    ...
    // stream_tasks_raw moved to streams.rs

    // stream_execution_processes_for_attempt_raw moved to streams.rs

    // stream_follow_up_draft_for_attempt_raw moved to streams.rs
