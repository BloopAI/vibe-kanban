...
fn default_branding_in_commit_and_pr_enabled() -> bool {
    true
}
...
pub struct Config {
    ...
    #[serde(default = "default_branding_in_commit_and_pr_enabled")]
    pub branding_in_commit_and_pr_enabled: bool,
}
...
impl Config {
    fn from_v7_config(old_config: v7::Config) -> Self {
        ...
        Self {
            ...
            branding_in_commit_and_pr_enabled: true,
        }
    }
